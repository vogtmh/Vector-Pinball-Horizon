# Vector Pinball Horizon

Vector Pinball Horizon is a pinball game for Android devices.
...
It is based on [Vector Pinball by Brian Nenninger](https://github.com/dozingcat/Vector-Pinball/)
This version adds support for horizontal devices like a TV or Android handheld, experimental support for analog triggers and an updated UI.
...
The GitHub project page is: [github.com/vogtmh/Vector-Pinball-Horizon/](https://github.com/vogtmh/Vector-Pinball-Horizon/).
...
## Download for the original game (and soon for this version)
